...
def main():
    ...
    rawDataFile = open(PROJECT_PATH + 'ranking_news_title.txt', 'r', encoding='utf-8') # read file
    newDateFile = open(PROJECT_PATH + 'ranking_news_new.txt', 'w', encoding='utf-8')
    corpusFile  = open(PROJECT_PATH + 'corpus.txt', 'w', encoding='utf-8')
